...
/* BlogPost.create({
    ...
    console.log("%s is saved", savedDoc.title);
    console.log("id is %s", savedDoc.id);
});
 */
...
var id = "6850d14ce267220bff89f64f";

/* BlogPost.findById(id).then( (error, blogpost) => {
    console.log(error, blogpost);
}); */
...
// BlogPost.findByIdAndDelete(id).then( (error, blogpost) => {
//     console.log(error, blogpost);
// });